...
use Yii;
use common\models\Tes;
use common\models\search\TesSearch;
...
class TesController extends Controller
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> 'Create new Tes',
                    'content'=>'<span class="text-success">'.'Create Tes success'.'</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-secondary float-left','data-bs-dismiss'=>'modal']).
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Tes model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
