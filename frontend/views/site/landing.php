    ...
    <div class="container-lg content-space-t-3 content-space-t-lg-4 content-space-b-2">
        <div class="w-lg-75 text-center mx-lg-auto text-center mx-auto">
            ...
            <div class="mb-7 animated fadeInUp">
                <h1 class="display-2 mb-3">Admin &amp; Dashboard theme <span
                ...
                <div class="position-relative">
                    ...
                    <div class="device-browser-frame">
                        <div class="js-img-comp-container hs-img-comp-container">
                            <img class="hs-img-comp hs-img-comp-a" src="<?= Url::home() ?>img/1618x1010/img1.jpg"
                                 alt="Image Description">

                            <div class="js-img-comp-wrapper hs-img-comp-wrapper">
                                <img class="hs-img-comp hs-img-comp-b" src="<?= Url::home() ?>img/1618x1010/img2.jpg"
                                     alt="Image Description">
                            </div>
                        </div>
                    </div>
            ...
            <a class="card card-lg card-transition h-100 bg-light border-0 shadow-none overflow-hidden"
               href="./index.html">
                <div class="card-body">
                    ...
                    <p class="card-text lead">Experience a native pilled-styled sidebar that can be minimized on the
                        fly.</p>
                </div>
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid shadow-lg" src="<?= Url::home() ?>img/900x562/img1.jpg"
                         alt="Image Description" data-hs-theme-appearance="default">
                    <img class="img-fluid shadow-lg" src="<?= Url::home() ?>img/900x562/img1-dark.jpg"
            ...
            <a class="card card-lg card-transition h-100 bg-light border-0 shadow-none overflow-hidden"
               href="./dashboard-default-dark.html">
                <div class="card-body">
                    ...
                    <p class="card-text lead">Leverage Front's user-friendly and yet powerful dark mode, which adapts to
                        the browser's default mode.</p>
                </div>
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid shadow-lg" src="<?= Url::home() ?>img/900x562/img6.jpg"
                         alt="Image Description">
                </div>
            </a>
            <!-- End Card -->
        ...
        <div class="col-md-6 mb-4">
            ...
            <a class="card card-lg card-transition h-100 bg-light border-0 shadow-none overflow-hidden"
               href="./dashboard-default-dark-sidebar.html">
                ...
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid shadow-lg" src="<?= Url::home() ?>img/900x562/img12.jpg"
                         alt="Image Description" data-hs-theme-appearance="default">
                    <img class="img-fluid shadow-lg" src="<?= Url::home() ?>img/900x562/img12-dark.jpg"
                         alt="Image Description" data-hs-theme-appearance="dark">
                </div>
            </a>
            <!-- End Card -->
        ...
        <div class="col-md-6 mb-4">
            ...
            <a class="card card-lg card-transition h-100 bg-light border-0 shadow-none overflow-hidden"
               href="./dashboard-default-light-sidebar.html">
                ...
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid shadow-lg" src="<?= Url::home() ?>img/900x562/img11.jpg"
                         alt="Image Description" data-hs-theme-appearance="default">
                    <img class="img-fluid shadow-lg" src="<?= Url::home() ?>img/900x562/img11-dark.jpg"
                         alt="Image Description" data-hs-theme-appearance="dark">
                </div>
            </a>
            <!-- End Card -->
            ...
            <a class="card card-lg card-transition h-100 bg-light border-0 shadow-none overflow-hidden"
               href="./dashboard-default-double-line.html">
                <div class="card-body">
                    ...
                    <p class="card-text lead">Present web app in full content with a double line collapsible navigation
                        bar.</p>
                </div>
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid shadow-lg" src="<?= Url::home() ?>img/900x562/img3.jpg"
                         alt="Image Description" data-hs-theme-appearance="default">
                    <img class="img-fluid shadow-lg" src="<?= Url::home() ?>img/900x562/img3-dark.jpg"
                         alt="Image Description" data-hs-theme-appearance="dark">
                </div>
            </a>
            <!-- End Card -->
            ...
            <a class="card card-lg card-transition h-100 bg-light border-0 shadow-none overflow-hidden"
               href="./dashboard-default-collapsible-layout.html">
                <div class="card-body">
                    ...
                    <p class="card-text lead">Present web app in full content with a single collapsible navigation
                        bar.</p>
                </div>
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid shadow-lg" src="<?= Url::home() ?>img/900x562/img2.jpg"
                         alt="Image Description" data-hs-theme-appearance="default">
                    <img class="img-fluid shadow-lg" src="<?= Url::home() ?>img/900x562/img2-dark.jpg"
                         alt="Image Description" data-hs-theme-appearance="dark">
                </div>
            </a>
            <!-- End Card -->
            ...
            <a class="card card-lg card-transition h-100 bg-light border-0 shadow-none overflow-hidden"
               href="./dashboard-default-sidebar-detached.html">
                <div class="card-body">
                    ...
                    <p class="card-text lead">Choose one of two detached sidebar options to create better navigation
                        options and usability.</p>
                </div>
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid shadow-lg" src="<?= Url::home() ?>img/900x562/img13.jpg"
                         alt="Image Description" data-hs-theme-appearance="default">
                    <img class="img-fluid shadow-lg" src="<?= Url::home() ?>img/900x562/img13-dark.jpg"
                         alt="Image Description" data-hs-theme-appearance="dark">
                </div>
            </a>
            <!-- End Card -->
            ...
            <a class="card card-lg card-transition h-100 bg-light border-0 shadow-none overflow-hidden"
               href="./dashboard-default-sidebar-detached-overlay.html">
                <div class="card-body">
                    ...
                    <p class="card-text lead">Provide more navigation options and usability on page level with overlay
                        sidebar detached.</p>
                </div>
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid shadow-lg" src="<?= Url::home() ?>img/900x562/img5.jpg"
                         alt="Image Description" data-hs-theme-appearance="default">
                    <img class="img-fluid shadow-lg" src="<?= Url::home() ?>img/900x562/img5-dark.jpg"
                         alt="Image Description" data-hs-theme-appearance="dark">
                </div>
            </a>
            <!-- End Card -->
...
<div class="container-lg">
    <div class="bg-light content-space-2 rounded-3 px-5">
        <div class="w-md-70 text-center mx-md-auto">
            <div class="mb-4">
                <img class="img-fluid mx-auto" src="<?= Url::home() ?>svg/illustrations/oc-review.svg"
                     alt="Image Description" data-hs-theme-appearance="default" style="max-width: 10rem;">
                <img class="img-fluid mx-auto" src="<?= Url::home() ?>svg/illustrations-light/oc-review.svg"
            ...
            <p class="fs-2 text-dark mb-4"><em>This is a perfect theme for a modern web application. <span
                            class="text-highlight-warning">There was clearly a lot of thought that went into designing</span>
                    all of the components to look coherent and work well together in various grid layouts.</em></p>
...
<div class="container-lg content-space-2 content-space-lg-3">
    ...
    <div class="w-lg-75 text-center mx-lg-auto mb-7 mb-md-10">
        ...
        <p class="lead">The Front features can be flexed according to your needs with dozens of options available and
            mix-and-match possibilities.</p>
    </div>
    <!-- End Heading -->
    ...
    <div class="row">
        <div class="col-md-7 mb-4">
            ...
            <div class="card card-lg h-100 bg-light border-0 shadow-none overflow-hidden">
                <div class="card-body">
                    ...
                    <p class="card-text lead">Front offers all kinds of calendar components for choosing date ranges,
                        dates and times.</p>
                </div>
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid" src="<?= Url::home() ?>img/others/img4.png" alt="Image Description"
                         data-hs-theme-appearance="default">
                    <img class="img-fluid" src="<?= Url::home() ?>img/others/img4-dark.png" alt="Image Description"
        ...
        <div class="col-md-5 mb-4">
            ...
            <div class="card card-lg h-100 bg-light border-0 shadow-none overflow-hidden">
                ...
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid" src="<?= Url::home() ?>img/others/img3.png" alt="Image Description"
                         data-hs-theme-appearance="default">
                    <img class="img-fluid" src="<?= Url::home() ?>img/others/img3-dark.png" alt="Image Description"
                         data-hs-theme-appearance="dark">
                </div>
            </div>
            <!-- End Card -->
        ...
        <div class="col-md-5 mb-4">
            ...
            <div class="card card-lg h-100 bg-light border-0 shadow-none overflow-hidden">
                <div class="card-body">
                    ...
                    <p class="card-text lead">Showcase your latest work with datatable options that provide a powerful
                        portfolio system, beautiful content designs or any other ordered grid content.</p>
                </div>
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid" src="<?= Url::home() ?>img/others/img6.png" alt="Image Description"
                         data-hs-theme-appearance="default">
                    <img class="img-fluid" src="<?= Url::home() ?>img/others/img6-dark.png" alt="Image Description"
                         data-hs-theme-appearance="dark">
                </div>
            </div>
            <!-- End Card -->
        ...
        <div class="col-md-7 mb-4">
            ...
            <div class="card card-lg h-100 bg-light border-0 shadow-none overflow-hidden">
                <div class="card-body">
                    ...
                    <p class="card-text lead">Allow cross-functional charts to deliver stunning content, data and all
                        kinds of information faster no matter use cases and devices.</p>
                </div>
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid" src="<?= Url::home() ?>img/others/img5.png" alt="Image Description"
                         data-hs-theme-appearance="default">
                    <img class="img-fluid" src="<?= Url::home() ?>img/others/img5-dark.png" alt="Image Description"
                         data-hs-theme-appearance="dark">
                </div>
            </div>
            <!-- End Card -->
        ...
        <div class="col-md-7 mb-4 mb-md-0">
            ...
            <div class="card card-lg h-100 bg-light border-0 shadow-none overflow-hidden">
                <div class="card-body">
                    ...
                    <p class="card-text lead">Upload images, videos or any files, copy to clipboard, toggle passwords,
                        search, add fields, count characters and discover more customizable and feature-rich
                        plugins.</p>
                </div>
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid" src="<?= Url::home() ?>img/others/img8.png" alt="Image Description"
                         data-hs-theme-appearance="default">
                    <img class="img-fluid" src="<?= Url::home() ?>img/others/img8-dark.png" alt="Image Description"
                         data-hs-theme-appearance="dark">
                </div>
            </div>
            <!-- End Card -->
        ...
        <div class="col-md-5">
            ...
            <div class="card card-lg h-100 bg-light border-0 shadow-none overflow-hidden">
                <div class="card-body">
                    ...
                    <p class="card-text lead">Create multi-step forms, validate and navigate through steps to get more
                        leads and increase engagement.</p>
                </div>
                <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                    <img class="img-fluid" src="<?= Url::home() ?>img/others/img7.png" alt="Image Description"
                         data-hs-theme-appearance="default">
                    <img class="img-fluid" src="<?= Url::home() ?>img/others/img7-dark.png" alt="Image Description"
                         data-hs-theme-appearance="dark">
                </div>
            </div>
            <!-- End Card -->
...
<div class="content-space-b-2">
    ...
    <div class="container-lg">
        <div class="w-lg-75 text-center mx-lg-auto mb-7 mb-md-10">
            ...
            <p class="lead">Whether you're creating a web application, dashboard, admin panels, or SASS based interface
                — Front Dashboard helps you create the best possible web application projects.</p>
        </div>
    </div>
    <!-- End Heading -->

    <div class="sliding-img mb-5">
        <div class="sliding-img-frame-to-start" style="background-image: url(<?= Url::home() ?>img/others/img1.png);"
             data-hs-theme-appearance="default"></div>
        <div class="sliding-img-frame-to-start"
             style="background-image: url(<?= Url::home() ?>img/others/img1-dark.png);"
             data-hs-theme-appearance="dark"></div>
    </div>

    <div class="sliding-img">
        <div class="sliding-img-frame-to-end" style="background-image: url(<?= Url::home() ?>img/others/img2.png);"
             data-hs-theme-appearance="default"></div>
        <div class="sliding-img-frame-to-end" style="background-image: url(<?= Url::home() ?>img/others/img2-dark.png);"
             data-hs-theme-appearance="dark"></div>
    </div>
</div>
<!-- End Sliding Image -->
...
<div class="container-lg">
    <div class="bg-light content-space-2 rounded-3 px-5">
        <div class="w-md-70 text-center mx-md-auto">
            ...
            <p class="fs-2 text-dark mb-4"><em>The theme has a very professional look, bringing a more modern and clean
                    style to the application. <span class="text-highlight-warning">The documentation is extraordinarily rich and complete</span>,
                    helping implementation.</em></p>
    ...
    <div class="row align-items-md-center content-space-b-1 content-space-b-lg-2">
        <div class="col-md-6 order-md-2 mb-10 mb-md-0">
            ...
            <figure class="device-browser">
                ...
                <div class="device-browser-frame">
                    <img class="img-fluid shadow-lg" src="<?= Url::home() ?>img/900x562/img7.jpg"
                         alt="Image Description" data-hs-theme-appearance="default">
                    <img class="img-fluid shadow-lg" src="<?= Url::home() ?>img/900x562/img7-dark.jpg"
                         alt="Image Description" data-hs-theme-appearance="dark">
                </div>
        ...
        <div class="col-md-6">
            <div class="pe-md-7">
                <div class="mb-5">
                    ...
                    <p class="fs-4">A board that visually depicts work at various stages of a process using cards to
                        represent work items and columns to represent each stage of the process.</p>
                </div>
    ...
    <div class="row align-items-md-center content-space-1 content-space-b-lg-2">
        <div class="col-md-6 order-md-2 mb-10 mb-md-0">
            ...
            <figure class="device-browser">
                ...
                <div class="device-browser-frame">
                    <img class="img-fluid shadow-lg" src="<?= Url::home() ?>img/900x562/img8.jpg"
                         alt="Image Description" data-hs-theme-appearance="default">
                    <img class="img-fluid shadow-lg" src="<?= Url::home() ?>img/900x562/img8-dark.jpg"
                         alt="Image Description" data-hs-theme-appearance="dark">
                </div>
        ...
        <div class="col-md-6">
            <div class="pe-md-7">
                <div class="mb-5">
                    ...
                    <p class="fs-4">Multiple views of your day, week and month, guest invites, calendar on the web and
                        more. It allows users to create, edit events, fill in quickly and easily.</p>
                </div>
    ...
    <div class="row align-items-md-center content-space-1 content-space-b-lg-2">
        <div class="col-md-6 order-md-2 mb-10 mb-md-0">
            ...
            <figure class="device-browser">
                ...
                <div class="device-browser-frame">
                    <img class="img-fluid shadow-lg" src="<?= Url::home() ?>img/900x562/img9.jpg"
                         alt="Image Description" data-hs-theme-appearance="default">
                    <img class="img-fluid shadow-lg" src="<?= Url::home() ?>img/900x562/img9-dark.jpg"
                         alt="Image Description" data-hs-theme-appearance="dark">
                </div>
        ...
        <div class="col-md-6">
            <div class="pe-md-7">
                <div class="mb-5">
                    ...
                    <p class="fs-4">Quickly make invoices with Front's attractive invoice template straight from your
                        web browser.</p>
                </div>
    ...
    <div class="row align-items-md-center content-space-t-1">
        <div class="col-md-6 order-md-2 mb-10 mb-md-0">
            ...
            <figure class="device-browser">
                ...
                <div class="device-browser-frame">
                    <img class="img-fluid shadow-lg" src="<?= Url::home() ?>img/900x562/img10.jpg"
                         alt="Image Description" data-hs-theme-appearance="default">
                    <img class="img-fluid shadow-lg" src="<?= Url::home() ?>img/900x562/img10-dark.jpg"
                         alt="Image Description" data-hs-theme-appearance="dark">
                </div>
        ...
        <div class="col-md-6">
            <div class="pe-md-7">
                <div class="mb-5">
                    ...
                    <p class="fs-4">Please your visitors with eye-catching and exciting file manager. Different options
                        and settings to manage your site.</p>
                </div>
                <a class="btn btn-primary" target="_blank" href="./apps-file-manager.html">Preview File Manager <i
                            class="bi-box-arrow-up-right ms-2"></i></a>
            </div>
        </div>
        <!-- End Col -->
...
<div class="container-lg">
    <div class="bg-dark position-relative rounded overflow-hidden pt-4 px-4 pt-sm-10 px-sm-10">
        ...
        <img class="img-fluid" src="<?= Url::home() ?>svg/illustrations/docs-main-page.svg" alt="Image Description"
             data-hs-theme-appearance="default">
        <img class="img-fluid" src="<?= Url::home() ?>svg/illustrations/docs-main-page-dark.svg" alt="Image Description"
             data-hs-theme-appearance="dark">
...
<div class="container-lg content-space-2 content-space-lg-3">
    <!-- Heading -->
    <div class="w-lg-75 text-center mx-lg-auto mb-7 mb-md-10">
        <h2 class="display-4">Build <span class="text-primary">tools</span> and full <span class="text-primary">documention</span>
        </h2>
        <p class="lead">Components, plugins, and build tools are all thoroughly documented with live examples and markup
            for easier use and customization.</p>
    </div>
    <!-- End Heading -->
    ...
    <div class="w-md-75 w-lg-50 mx-md-auto mb-5 mb-md-9">
        ...
        <div class="text-center mb-7">
            <p>Not comfortable diving that deep? No worries, you just use the compiled CSS and examples pages! <a
                        class="link" href="./documentation/gulp.html">Learn more <i class="bi-chevron-right small"></i></a>
            </p>
        </div>

        <div class="row justify-content-center">
            <div class="col-auto col-sm-3 col-sm py-3">
                <img class="avatar avatar-xl avatar-4x3" src="<?= Url::home() ?>svg/brands/bootstrap-gray.svg"
                     alt="Logo">
            </div>
            <!-- End Col -->

            <div class="col-auto col-sm-3 col-sm py-3">
                <img class="avatar avatar-xl avatar-4x3" src="<?= Url::home() ?>svg/brands/sass-gray.svg" alt="Logo">
            </div>
            <!-- End Col -->

            <div class="col-auto col-sm-3 col-sm py-3">
                <img class="avatar avatar-xl avatar-4x3" src="<?= Url::home() ?>svg/brands/gulp-gray.svg" alt="Logo">
            </div>
            <!-- End Col -->

            <div class="col-auto col-sm-3 col-sm py-3">
                <img class="avatar avatar-xl avatar-4x3" src="<?= Url::home() ?>svg/brands/npm-gray.svg" alt="Logo">
            </div>
            <!-- End Col -->
        </div>
        <!-- End Row -->
    ...
    <div class="bg-light content-space-2 rounded-3 px-5">
        <div class="w-md-70 text-center mx-md-auto">
            ...
            <p class="fs-2 text-dark mb-4"><em>This theme is really great, as back end developer <span
                            class="text-highlight-warning">I was able to build an impressive front end using this theme in plain JavaScript vanilla. The source code is clear and the documentation as well, for me it's the best purchase I made with this team and I am watching evolution.</span>
                    Thank you so much for such quality and price. Keep going!</em></p>
            ...
            <div class="position-relative">
                <div class="bg-dark rounded-2 p-5">
                    ...
                    <div class="row align-items-sm-center">
                        ...
                        <div class="col-sm-7 col-md-5">
                            <p class="text-white-70 mb-0">All the same examples as the Standard License, but you could
                                build all of them with a single Multisite license.</p>
                        </div>
                        <!-- End Col -->
                ...
                <div class="d-none d-md-block position-absolute bottom-0 start-0">
                    <img class="img-fluid" src="<?= Url::home() ?>svg/illustrations/oc-peeking.svg"
                         alt="Image Description" data-hs-theme-appearance="default"
                         style="max-width: 8rem; margin-left: -7.8125rem;">
                    <img class="img-fluid" src="<?= Url::home() ?>svg/illustrations-light/oc-peeking.svg"
                         alt="Image Description" data-hs-theme-appearance="dark"
                         style="max-width: 8rem; margin-left: -7.8125rem;">
                </div>

                <div class="d-none d-md-block position-absolute top-50 end-0 translate-middle-y">
                    <img class="img-fluid" src="<?= Url::home() ?>svg/illustrations/oc-on-the-go.svg"
                         alt="Image Description" data-hs-theme-appearance="default"
                         style="max-width: 15rem; margin-right: -15rem;">
                    <img class="img-fluid" src="<?= Url::home() ?>svg/illustrations-light/oc-on-the-go.svg"
                         alt="Image Description" data-hs-theme-appearance="dark"
                         style="max-width: 15rem; margin-right: -15rem;">
                </div>
            </div>
...
<div class="container-lg content-space-t-2 content-space-t-lg-3">
    ...
    <div class="w-md-75 mx-md-auto">
        ...
        <ul class="list-unstyled list-py-3 mb-0">
            <li>
                ...
                <p class="fs-4">If you'd like a refund please reach out to us at <a class="link"
                    ...
                    If you need technical help with the theme before a refund please reach out to us first.</p>
            </li>

            <li>
                <h2 class="h1">How do I get access to a theme I purchased?</h2>
                <p class="fs-4">If you lose the link for a theme you purchased, don't panic! We've got you covered. You
                    can login to your account, tap your avatar in the upper right corner, and tap Purchases. If you
                    didn't create a <a class="link" href="https://marketplace.getbootstrap.com/signin/" target="_blank">login</a>
                    or can't remember the information, you can use our handy <a class="link"
                                                                                href="https://themes.getbootstrap.com/redownload/"
                                                                                target="_blank">Redownload page</a>,
            ...
            <li>
                ...
                <p class="fs-4">Technical support for each theme is given directly by the creator of the theme. You can
                    contact us <a class="link" href="https://htmlstream.com/contact-us" target="_blank">here</a></p>
            </li>

            <li>
                <h2 class="h1">Is Front Admin available on other web application platforms?</h2>
                <p class="fs-4">Since the theme is a static HTML template, we do not offer any tutorials or any other
                    materials on how to integrate our templates with any CMS, Web Application framework, or any other
                    similar technology. However, since our templates are static HTML/CSS and JS templates, then they
                    should be compatible with any backend technology.</p>
            </li>

            <li>
                <h2 class="h1">How can I access a Figma or Sketch file?</h2>
                <p class="fs-4">Unfortunately, the design files are not available. We will consider the possibility of
                    adding this option in the near future. However, we cannot provide any ETA regarding the release.</p>
            </li>
        </ul>
        <!-- End List -->
        ...
        <div class="text-center">
            ...
            <p><a class="link" href="https://htmlstream.com/contact-us" target="_blank">Send us a message</a> and we'll
                get back to you.</p>
        </div>
    </div>
</div>
