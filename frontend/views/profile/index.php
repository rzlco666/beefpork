                     ...
                     "stickyOffsetTop": 20
                        ...
                        <div class="card-body">
                            <ul class="list-unstyled list-py-2 text-dark mb-0">
                                ...
                                <li><i class="bi-at dropdown-item-icon"></i> <?= Yii::$app->user->identity->email ?></li>
                                    ...
                                    <li class="step-item">
                                        <div class="step-content-wrapper">
                                            ...
                                            <div class="step-content">
                                                <h5 class="step-title">
                                                    <a class="text-dark" href="#">Task report - uploaded weekly
                                                        reports</a>
                                                </h5>

                                                <p class="fs-5 mb-1">Added 3 files to task <a class="text-uppercase"
                                                                                              href="#"><i
                                      ...
                                      <span class="flex-shrink-0">
                                        <img class="avatar avatar-xs" src="<?= Url::home() ?>svg/brands/excel-icon.svg"
                                             alt="Image Description">
                                      </span>
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="d-flex">
                                      <span class="flex-shrink-0">
                                        <img class="avatar avatar-xs" src="<?= Url::home() ?>svg/brands/word-icon.svg"
                                             alt="Image Description">
                                      </span>
                                                                    <div class="flex-grow-1 text-truncate ms-2">
                                                                        <span class="d-block fs-6 text-dark text-truncate"
                                            ...
                                            <div class="step-content">
                                                ...
                                                <p class="fs-5 mb-1">Marked <a class="text-uppercase" href="#"><i
                                                            ...
                                                            class="badge bg-soft-primary text-primary rounded-pill"><span
                                                                class="legend-indicator bg-primary"></span>"In progress"</span>
                                                </p>
                                    ...
                                    <li id="collapseActivitySection" class="step-item collapse">
                                        <div class="step-content-wrapper">
                                            ...
                                            <div class="step-content">
                                                ...
                                                <p class="fs-5 mb-1">Updated <a class="text-uppercase" href="#"><i
                                                                class="bi-journal-bookmark-fill"></i> Fr-3</a> as <span
                                                            class="badge bg-soft-secondary text-secondary rounded-pill"><span
                                                                class="legend-indicator bg-secondary"></span>"To do"</span>
                                                </p>
                                                    ...
                                                    <div class="ms-auto">
                                                        ...
                                                        <div class="form-check form-check-switch">
                                                            <input class="form-check-input" type="checkbox" value=""
                                                                   id="connectionsCheckbox1" checked>
                                                            <label class="form-check-label btn-icon btn-xs rounded-circle"
                                                                   for="connectionsCheckbox1">
                                                        ...
                                                        <div class="flex-shrink-0">
                                                            <div class="avatar avatar-sm avatar-circle">
                                                                <img class="avatar-img"
                                                                     src="<?= Url::home() ?>img/160x160/img8.jpg"
                                                                     alt="Image Description">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <a class="d-flex align-items-center me-2" href="#">
                                                        <div class="flex-shrink-0">
                                                            <div class="avatar avatar-sm avatar-circle">
                                                                <img class="avatar-img"
                                                                     src="<?= Url::home() ?>img/160x160/img3.jpg"
                                                                     alt="Image Description">
                                                                <span class="avatar-status avatar-sm-status avatar-status-warning"></span>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="ms-auto">
                                                        ...
                                                        <div class="form-check form-check-switch">
                                                            <input class="form-check-input" type="checkbox" value=""
                                                                   id="connectionsCheckbox3" checked>
                                                            <label class="form-check-label btn-icon btn-xs rounded-circle"
                                                                   for="connectionsCheckbox3">
                                    <span class="form-check-default">
                                      <i class="bi-person-plus-fill"></i>
                                    </span>
                                                                <span class="form-check-active">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <a class="d-flex align-items-center me-2" href="#">
                                                        <div class="flex-shrink-0">
                                                            <div class="avatar avatar-sm avatar-circle">
                                                                <img class="avatar-img"
                                                                     src="<?= Url::home() ?>img/160x160/img6.jpg"
                                                                     alt="Image Description">
                                ...
                                <span class="avatar-initials">U</span>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <img class="avatar avatar-xs"
                                                     src="<?= Url::home() ?>svg/brands/spec-icon.svg"
                                                     alt="Image Description">
                                                <div class="ms-3">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex">
                                                <img class="avatar avatar-xs"
                                                     src="<?= Url::home() ?>svg/brands/capsule-icon.svg"
                                                     alt="Image Description">
                                                <div class="ms-3">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex">
                                                <img class="avatar avatar-xs"
                                                     src="<?= Url::home() ?>svg/brands/mailchimp-icon.svg"
                                                     alt="Image Description">
                                                <div class="ms-3">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex">
                                                <img class="avatar avatar-xs"
                                                     src="<?= Url::home() ?>svg/brands/figma-icon.svg"
                                                     alt="Image Description">
                                                <div class="ms-3">
